...
export const blogPageType = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "featuredPost",
      title: "Öne Çıkan Blog Yazısı",
      type: "reference",
      to: [{ type: "blogPost" }],
      description: "Blog sayfasının en üstünde büyük olarak gösterilecek yazı. Boş bırakılırsa en son yazılan blog yazısı öne çıkarılır.",
      group: "hero",
    }),
